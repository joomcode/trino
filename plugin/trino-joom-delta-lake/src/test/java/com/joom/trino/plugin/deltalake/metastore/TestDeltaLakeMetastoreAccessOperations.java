...
import com.joom.trino.plugin.deltalake.TestingDeltaLakePlugin;
        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        queryRunner.createCatalog("joom_delta_lake", "joom-delta-lake", deltaLakeProperties.buildOrThrow());
