 ...
 */
package com.joom.trino.plugin.deltalake.metastore;
...
import com.joom.trino.plugin.deltalake.DeltaLakeColumnHandle;
import com.joom.trino.plugin.deltalake.DeltaLakeConfig;
import com.joom.trino.plugin.deltalake.DeltaLakeTableHandle;
import com.joom.trino.plugin.deltalake.statistics.CachingExtendedStatisticsAccess;
import com.joom.trino.plugin.deltalake.statistics.ExtendedStatistics;
import com.joom.trino.plugin.deltalake.statistics.MetaDirStatisticsAccess;
import com.joom.trino.plugin.deltalake.transactionlog.MetadataEntry;
import com.joom.trino.plugin.deltalake.transactionlog.TransactionLogAccess;
import com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointSchemaManager;
...
import static com.joom.trino.plugin.deltalake.DeltaLakeMetadata.PATH_PROPERTY;
import static com.joom.trino.plugin.deltalake.DeltaTestingConnectorSession.SESSION;
...
{
    private static final ColumnHandle COLUMN_HANDLE = new DeltaLakeColumnHandle("val", DoubleType.DOUBLE, REGULAR, Optional.empty());
    ...
    public void testStatisticsParquetParsedStatistics()
    {
        ...
        ColumnStatistics columnStats = statisticsMap.get(new DeltaLakeColumnHandle("dec_short", DecimalType.createDecimalType(5, 1), REGULAR, Optional.empty()));
        ...
        columnStats = statisticsMap.get(new DeltaLakeColumnHandle("dec_long", DecimalType.createDecimalType(25, 3), REGULAR, Optional.empty()));
        assertEquals(columnStats.getNullsFraction(), Estimate.zero());
    ...
    public void testStatisticsParquetParsedStatisticsNaNValues()
    {
        ...
        Map<ColumnHandle, ColumnStatistics> statisticsMap = stats.getColumnStatistics();
        ColumnStatistics columnStats = statisticsMap.get(new DeltaLakeColumnHandle("fl", REAL, REGULAR, Optional.empty()));
        assertEquals(columnStats.getNullsFraction(), Estimate.zero());
    ...
    public void testStatisticsParquetParsedStatisticsNullCount()
    {
        ...
        Map<ColumnHandle, ColumnStatistics> statisticsMap = stats.getColumnStatistics();
        ColumnStatistics columnStats = statisticsMap.get(new DeltaLakeColumnHandle("i", INTEGER, REGULAR, Optional.empty()));
