...
import static com.joom.trino.plugin.deltalake.DeltaLakeWriter.mergeStats;
...
public class TestDeltaLakeWriter
{
    ...
    public void testMergeIntStatistics()
    {
        ...
        DeltaLakeColumnHandle intColumn = new DeltaLakeColumnHandle(columnName, INTEGER, REGULAR, Optional.empty());
    ...
    public void testMergeFloatStatistics()
    {
        ...
        DeltaLakeColumnHandle floatColumn = new DeltaLakeColumnHandle(columnName, REAL, REGULAR, Optional.empty());
    ...
    public void testMergeDoubleNaNStatistics()
    {
        ...
        DeltaLakeColumnHandle doubleColumn = new DeltaLakeColumnHandle(columnName, DOUBLE, REGULAR, Optional.empty());
    ...
    public void testMergeStringStatistics()
    {
        ...
        DeltaLakeColumnHandle varcharColumn = new DeltaLakeColumnHandle(columnName, VarcharType.createUnboundedVarcharType(), REGULAR, Optional.empty());
