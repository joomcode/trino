...
import static com.joom.trino.plugin.deltalake.util.MinioContainer.MINIO_ACCESS_KEY;
import static com.joom.trino.plugin.deltalake.util.MinioContainer.MINIO_SECRET_KEY;
...
public class TestDeltaLakePerTransactionMetastoreCache
{
            ...
            throws Exception
    {
        ...
        queryRunner.createCatalog(DELTA_CATALOG, "joom-delta-lake", deltaLakeProperties.buildOrThrow());
