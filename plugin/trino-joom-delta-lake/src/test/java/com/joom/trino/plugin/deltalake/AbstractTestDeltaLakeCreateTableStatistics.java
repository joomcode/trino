...
import com.joom.trino.plugin.deltalake.util.DockerizedMinioDataLake;
...
import static com.joom.trino.plugin.deltalake.DeltaLakeDockerizedMinioDataLake.createDockerizedMinioDataLakeForDeltaLake;
import static com.joom.trino.plugin.deltalake.DeltaLakeQueryRunner.DELTA_CATALOG;
        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        try (TestTable table = new TestTable(
            ...
            DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle("d", createUnboundedVarcharType(), REGULAR, Optional.empty());
            ...
            for (String complexColumn : ImmutableList.of("a", "b", "c")) {
                columnHandle = new DeltaLakeColumnHandle(complexColumn, createUnboundedVarcharType(), REGULAR, Optional.empty());
            ...
            throws Exception
    {
        ...
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle(columnName, DoubleType.DOUBLE, REGULAR, Optional.empty());
            ...
            throws Exception
    {
        ...
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle(columnName, DecimalType.createDecimalType(precision, scale), REGULAR, Optional.empty());
        try (TestTable table = new TestTable(
            ...
            throws Exception
    {
        ...
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle(columnName, createUnboundedVarcharType(), REGULAR, Optional.empty());
        try (TestTable table = new TestTable(
            ...
            throws Exception
    {
        ...
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle(columnName, DateType.DATE, REGULAR, Optional.empty());
        try (TestTable table = new TestTable(
                "test_date_records_",
                ImmutableList.of(columnName),
            ...
            throws Exception
    {
        ...
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle(columnName, TIMESTAMP_TZ_MILLIS, REGULAR, Optional.empty());
        try (TestTable table = new TestTable(
    ...
    public void testMultiFileTable()
            throws Exception
    {
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle("name", createUnboundedVarcharType(), REGULAR, Optional.empty());
