 ...
 */
package com.joom.trino.plugin.deltalake.transactionlog.checkpoint;
...
import com.joom.trino.plugin.deltalake.transactionlog.TransactionEntry;
import com.joom.trino.plugin.deltalake.transactionlog.statistics.DeltaLakeParquetFileStatistics;
...
import static com.joom.trino.plugin.deltalake.DeltaLakeErrorCode.DELTA_LAKE_BAD_DATA;
...
import static com.joom.trino.plugin.deltalake.transactionlog.TransactionLogAccess.columnsWithStats;
import static com.joom.trino.plugin.deltalake.transactionlog.TransactionLogParser.START_OF_MODERN_ERA;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.ADD;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.COMMIT;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.METADATA;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.PROTOCOL;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.REMOVE;
import static com.joom.trino.plugin.deltalake.transactionlog.checkpoint.CheckpointEntryIterator.EntryType.TRANSACTION;
        ...
        implements Iterator<DeltaLakeTransactionLogEntry>
{
    ...
    private DeltaLakeColumnHandle buildColumnHandle(EntryType entryType, CheckpointSchemaManager schemaManager, MetadataEntry metadataEntry)
    {
        ...
        return new DeltaLakeColumnHandle(entryType.getColumnName(), type, REGULAR, Optional.empty());
    }
