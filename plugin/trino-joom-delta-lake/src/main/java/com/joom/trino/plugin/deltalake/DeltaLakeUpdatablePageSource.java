...
import static com.joom.trino.plugin.deltalake.DeltaLakePageSink.createPartitionValues;
import static com.joom.trino.plugin.deltalake.DeltaLakeSessionProperties.getParquetMaxReadBlockSize;
import static com.joom.trino.plugin.deltalake.DeltaLakeSessionProperties.isParquetUseColumnIndex;
import static com.joom.trino.plugin.deltalake.transactionlog.DeltaLakeSchemaSupport.extractSchema;
import static com.joom.trino.plugin.deltalake.transactionlog.TransactionLogParser.deserializePartitionValue;
        ...
        implements UpdatablePageSource
{
    ...
    {
        //todo: test optional.empty
        return new DeltaLakeColumnHandle("$delta$dummy_row_index", BIGINT, DeltaLakeColumnType.SYNTHESIZED, Optional.empty())
        {
            @Override
        ...
        for (int i = 0; i < partitionValues.length; i++) {
            ...
            partitionValues[i] = nativeValueToBlock(
                    ...
                    deserializePartitionValue(
                            new DeltaLakeColumnHandle(columnMetadata.getName(), columnMetadata.getType(), PARTITION_KEY, Optional.empty()),
