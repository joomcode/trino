...
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(DeltaLakeColumnProjectionInfo.class).instanceSize();
    ...
    {
        return Optional.of(new HiveColumnProjectionInfo(
                dereferenceIndices,
                dereferenceNames,
                hiveType,
                type));
    ...
    public boolean equals(Object obj)
    {
        ...
        DeltaLakeColumnProjectionInfo other = (DeltaLakeColumnProjectionInfo) obj;
